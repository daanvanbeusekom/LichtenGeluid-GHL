...
<head>
  ...
  <title>AdminLG | Lockscreen</title>
...
<div class="lockscreen-wrapper">
  <div class="lockscreen-logo">
    <a href="lockscreen.php"><b>Admin</b>L&G</a>
  </div>
  <!-- User name -->
  <div class="lockscreen-name"><?php echo $user_name;?></div>
    ...
    <?php
            ...
            //Create Variables
                ...
                $SQL = "SELECT user_id, user_name, user_email, user_image,user_level FROM users WHERE user_email ='$user_email' AND  user_pass ='$user_pass'";
                $result = $conn->query($SQL);
                    if(!$result){
                    ...
                    if($result->num_rows == 0){
                        ...
                        if(isset($_COOKIE['url_lock'])){
                            $url = $_COOKIE['url_lock'];
                            setcookie("url_lock", "", time() - 3600, "/");
                        }else{
                            $url = 'index.php';
                        }
  ...
  <div class="lockscreen-footer text-center">
    Copyright &copy; 2016-2017 <b><a href="http://mheventzz.nl" class="text-black">Licht & Geluid</a></b><br>
    All rights reserved
  </div>
</div>
<!-- /.center -->
