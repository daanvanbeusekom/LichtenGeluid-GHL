...
?>
    ...
    <div class="login-box">
      <div class="login-logo">
        <a href="login.php"><b>Admin</b>L&G</a>
      </div>
      <!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <?php
                ...
                if(!empty($errorArray)){
                    ...
                    $SQL = "SELECT user_id, user_name, user_email, user_online, user_image, user_description, user_level FROM users WHERE user_email ='$user_email' AND user_pass ='$user_pass'";
