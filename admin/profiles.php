                            ...
                            echo "<div class='row'>";
                                echo "<div class='col-sm-4 border-right'>";
                                    echo "<div class='description-block'>";
                                        $user_time = date('Y-m-d') - $row['user_since'];
                                        echo "<h5 class='description-header'>" . $user_time . "</h5>";
                                        echo "<span class='description-text'>Jaar lid</span>";
                                    echo "</div>";
                                echo "</div>";
